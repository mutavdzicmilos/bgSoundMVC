 ...
 */
public class RentTransTableModel extends AbstractTableModel {

    private final String[] columns = new String[]{"ID", "NAME", "SURNAME", "EQID", "COID", "DATE FROM", "DATE TO"};
    private final Class[] classes = new Class[]{Integer.class, String.class, String.class, Integer.class, Integer.class, Date.class, Date.class};

    public RentTransTableModel(List<Rent> rents) {
        this.rents = rents;
    }
